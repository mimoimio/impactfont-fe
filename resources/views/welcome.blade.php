    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                @auth
                    <a href="{{ url('/posts') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Posts</a>
                @else
                    <a href="{{ route('login') }}"
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <div
                        ...
                        <div>
                            <h2 class="mt-6 text-xl font-semibold text-gray-900">Welcome to Laravel Learn</h2>
                            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                This is a learning project to explore Laravel features, Blade templates, and Jetstream.
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <h2 class="mt-6 text-xl font-semibold text-gray-900">Notes Feature</h2>
                            <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                                Check out the hardcoded notes section to see how Blade templates and routing work
                                without a database.
                            </p>
                        </div>
                    </div>
